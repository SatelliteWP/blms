var blms_debug = parseInt( settings_options.debug ) ? true : false;
...
function blms_badge(){
    ...
    var site_language = settings_options.language.indexOf( 'fr' );
    var blms_language = ( site_language !== -1 ) ? 'fr' : '';
    lang = '?lang=' + blms_language;
    ...
    p.setAttribute( 'data-style', settings_options.badge_location );
